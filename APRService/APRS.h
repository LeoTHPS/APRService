...
enum APRS_TELEMETRY_TYPES
{
	...
	APRS_TELEMETRY_TYPE_PARAMS,
	APRS_TELEMETRY_TYPE_UNITS,
	APRS_TELEMETRY_TYPE_EQNS,
	APRS_TELEMETRY_TYPE_BITS,
...
APRSERVICE_EXPORT bool                              APRSERVICE_CALL aprs_packet_weather_is_raw(struct aprs_packet* packet);
...
APRSERVICE_EXPORT uint8_t                           APRSERVICE_CALL aprs_packet_telemetry_get_bits(struct aprs_packet* packet);
APRSERVICE_EXPORT const struct aprs_telemetry_eqn** APRSERVICE_CALL aprs_packet_telemetry_get_eqns(struct aprs_packet* packet);
APRSERVICE_EXPORT const char**                      APRSERVICE_CALL aprs_packet_telemetry_get_units(struct aprs_packet* packet);
APRSERVICE_EXPORT const char**                      APRSERVICE_CALL aprs_packet_telemetry_get_params(struct aprs_packet* packet);
