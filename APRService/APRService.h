...
typedef void(APRSERVICE_CALL *aprservice_command_handler)(struct aprservice* service, struct aprservice_command* command, struct aprs_packet* packet, const char* sender, const char* name, const char* args, void* param);
typedef bool(APRSERVICE_CALL *aprservice_command_filter_handler)(struct aprservice* service, struct aprservice_command* command, struct aprs_packet* packet, const char* sender, const char* name, const char* args, void* param);
...
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_is_read_only(const struct aprservice* service);
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_is_connected(const struct aprservice* service);
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_is_authenticated(const struct aprservice* service);
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_is_authenticating(const struct aprservice* service);
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_is_monitoring_enabled(const struct aprservice* service);
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_is_compression_enabled(const struct aprservice* service);
APRSERVICE_EXPORT struct aprs_path*              APRSERVICE_CALL aprservice_get_path(const struct aprservice* service);
APRSERVICE_EXPORT uint32_t                       APRSERVICE_CALL aprservice_get_time(const struct aprservice* service);
APRSERVICE_EXPORT int                            APRSERVICE_CALL aprservice_get_time_type(const struct aprservice* service);
APRSERVICE_EXPORT const char*                    APRSERVICE_CALL aprservice_get_comment(const struct aprservice* service);
APRSERVICE_EXPORT const char*                    APRSERVICE_CALL aprservice_get_station(const struct aprservice* service);
APRSERVICE_EXPORT char                           APRSERVICE_CALL aprservice_get_symbol_table(const struct aprservice* service);
APRSERVICE_EXPORT char                           APRSERVICE_CALL aprservice_get_symbol_table_key(const struct aprservice* service);
APRSERVICE_EXPORT void                           APRSERVICE_CALL aprservice_get_position(const struct aprservice* service, float* latitude, float* longitude, int32_t* altitude, uint16_t* speed, uint16_t* course);
APRSERVICE_EXPORT enum APRSERVICE_POSITION_TYPES APRSERVICE_CALL aprservice_get_position_type(const struct aprservice* service);
APRSERVICE_EXPORT const char*                    APRSERVICE_CALL aprservice_get_command_prefix(const struct aprservice* service);
APRSERVICE_EXPORT uint32_t                       APRSERVICE_CALL aprservice_get_connection_timeout(const struct aprservice* service);
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_get_event_handler(const struct aprservice* service, enum APRSERVICE_EVENTS event, aprservice_event_handler* handler, void** param);
APRSERVICE_EXPORT void                           APRSERVICE_CALL aprservice_get_default_event_handler(const struct aprservice* service, aprservice_event_handler* handler, void** param);
...
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_send_third_party(struct aprservice* service, const char* content);
...
APRSERVICE_EXPORT int                            APRSERVICE_CALL aprservice_wait_for_io(struct aprservice* service, uint32_t timeout);
...
APRSERVICE_EXPORT void                           APRSERVICE_CALL aprservice_task_get_handler(const struct aprservice_task* task, aprservice_task_handler* handler, void** param);
APRSERVICE_EXPORT struct aprservice*             APRSERVICE_CALL aprservice_task_get_service(const struct aprservice_task* task);
...
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_item_is_alive(const struct aprservice_item* item);
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_item_is_compressed(const struct aprservice_item* item);
APRSERVICE_EXPORT struct aprservice*             APRSERVICE_CALL aprservice_item_get_service(const struct aprservice_item* item);
APRSERVICE_EXPORT const char*                    APRSERVICE_CALL aprservice_item_get_name(const struct aprservice_item* item);
APRSERVICE_EXPORT const char*                    APRSERVICE_CALL aprservice_item_get_comment(const struct aprservice_item* item);
APRSERVICE_EXPORT uint16_t                       APRSERVICE_CALL aprservice_item_get_speed(const struct aprservice_item* item);
APRSERVICE_EXPORT uint16_t                       APRSERVICE_CALL aprservice_item_get_course(const struct aprservice_item* item);
APRSERVICE_EXPORT int32_t                        APRSERVICE_CALL aprservice_item_get_altitude(const struct aprservice_item* item);
APRSERVICE_EXPORT float                          APRSERVICE_CALL aprservice_item_get_latitude(const struct aprservice_item* item);
APRSERVICE_EXPORT float                          APRSERVICE_CALL aprservice_item_get_longitude(const struct aprservice_item* item);
APRSERVICE_EXPORT char                           APRSERVICE_CALL aprservice_item_get_symbol_table(const struct aprservice_item* item);
APRSERVICE_EXPORT char                           APRSERVICE_CALL aprservice_item_get_symbol_table_key(const struct aprservice_item* item);
...
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_object_is_alive(const struct aprservice_object* object);
APRSERVICE_EXPORT bool                           APRSERVICE_CALL aprservice_object_is_compressed(const struct aprservice_object* object);
APRSERVICE_EXPORT struct aprservice*             APRSERVICE_CALL aprservice_object_get_service(const struct aprservice_object* object);
APRSERVICE_EXPORT const char*                    APRSERVICE_CALL aprservice_object_get_name(const struct aprservice_object* object);
APRSERVICE_EXPORT const char*                    APRSERVICE_CALL aprservice_object_get_comment(const struct aprservice_object* object);
APRSERVICE_EXPORT uint16_t                       APRSERVICE_CALL aprservice_object_get_speed(const struct aprservice_object* object);
APRSERVICE_EXPORT uint16_t                       APRSERVICE_CALL aprservice_object_get_course(const struct aprservice_object* object);
APRSERVICE_EXPORT int32_t                        APRSERVICE_CALL aprservice_object_get_altitude(const struct aprservice_object* object);
APRSERVICE_EXPORT float                          APRSERVICE_CALL aprservice_object_get_latitude(const struct aprservice_object* object);
APRSERVICE_EXPORT float                          APRSERVICE_CALL aprservice_object_get_longitude(const struct aprservice_object* object);
APRSERVICE_EXPORT char                           APRSERVICE_CALL aprservice_object_get_symbol_table(const struct aprservice_object* object);
APRSERVICE_EXPORT char                           APRSERVICE_CALL aprservice_object_get_symbol_table_key(const struct aprservice_object* object);
...
APRSERVICE_EXPORT const char*                    APRSERVICE_CALL aprservice_command_get_help(const struct aprservice_command* command);
APRSERVICE_EXPORT void                           APRSERVICE_CALL aprservice_command_get_filter(const struct aprservice_command* command, aprservice_command_filter_handler* handler, void** param);
APRSERVICE_EXPORT void                           APRSERVICE_CALL aprservice_command_get_handler(const struct aprservice_command* command, aprservice_command_handler* handler, void** param);
APRSERVICE_EXPORT struct aprservice*             APRSERVICE_CALL aprservice_command_get_service(const struct aprservice_command* command);
