...
Create a solution with the files in this repository.
Download Lua 5.4 and add all src files to the solution except lua.c and luac.c.
Download AbstractionLayer and add its contents to the solution's include path.
Build.
